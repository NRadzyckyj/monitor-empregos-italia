...
2. No repositório GitHub, crie os secrets `TELEGRAM_JOBS_BOT_TOKEN` e `TELEGRAM_JOBS_CHAT_ID`.
3. Execute **Monitor de empregos na Itália** manualmente com `send_test_alert` para validar o novo bot.
